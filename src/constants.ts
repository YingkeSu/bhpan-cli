export const DEFAULT_PUBKEY = `-----BEGIN PUBLIC KEY-----
...
export const MISSING_CERT_PEM = `-----BEGIN CERTIFICATE-----
...
export const OAUTH_CLIENT_ID = "0f4bc444-d39a-4945-84a3-023d1f439148";
export const OAUTH_BASIC_AUTH = "Basic MGY0YmM0NDQtZDM5YS00OTQ1LTg0YTMtMDIzZDFmNDM5MTQ4OnVOaVU0V0ZUd1FEfjE4T2JHMkU1M2dqN3ot";
